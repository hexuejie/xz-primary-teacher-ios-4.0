...
@implementation LXDeviceVersion
...
+ (DeviceSize)deviceSize
{
    ...
    if ([LXDeviceVersion versionGreaterThanOrEqualTo:@"8"]) {
...
{
    return [LXDeviceVersion deviceNameForVersion:[LXDeviceVersion deviceVersion]];
}
