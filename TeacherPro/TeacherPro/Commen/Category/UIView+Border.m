...
-(void)addAllBorderWithHeight:(CGFloat)height andColor:(UIColor*)color
{
    [self addAllBorderWithHeight:height cornerRadius:3.0 andColor:color];
}

-(void)addAllBorderWithHeight:(CGFloat)height cornerRadius:(CGFloat)corner andColor:(UIColor*)color
{
