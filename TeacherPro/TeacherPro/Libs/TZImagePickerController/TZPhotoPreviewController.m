...
//    _naviBar.alpha = 0.7;
    ...
    [_backButton setImage:[UIImage imageNamedFromMyBundle:@"testreturn.png"] forState:UIControlStateNormal];
...
- (void)configBottomToolBar {
    ...
    _doneButton.frame = CGRectMake(self.view.tz_width - 88 - 12, 0, 88, 44);
   ...
   NSString* doneButtonTitle = [NSString stringWithFormat:@"%@(%zd/%zd)",_tzImagePickerVc.doneBtnTitleStr,_tzImagePickerVc.selectedModels.count,_tzImagePickerVc.maxImagesCount];
