...
- (void)viewDidLoad {
    ...
    // 默认的外观，你可以在这个方法后重置
    self.oKButtonTitleColorNormal   = HexRGB(0x333333);
...
//        self.navigationBar.tintColor = [UIColor whiteColor];
        ...
        self.navigationBar.tintColor = HexRGB(0x4d4d4d);
...
- (void)configDefaultSetting {
    ...
    self.naviTitleColor = HexRGB(0x4d4d4d);
    self.naviTitleFont = [UIFont systemFontOfSize:16];
