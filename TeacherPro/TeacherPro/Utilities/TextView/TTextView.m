...
@property (nonatomic, copy) TextViewHandler changeHandler; ///< 文本改变Block
@property (nonatomic, copy) TextViewHandler maxHandler; ///< 达到最大限制字符数Block
...
- (void)addTextDidChangeHandler:(TextViewHandler)changeHandler{
