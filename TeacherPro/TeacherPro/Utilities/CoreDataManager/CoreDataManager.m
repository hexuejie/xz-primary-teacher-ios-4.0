...
static NSString * const coreDataPersistentStorePath = @"TeacherCoreData.sqlite";
...
- (NSManagedObjectContext *)managedObjectContext
{
    if (!_managedObjectContext)
    {
        ...
        NSString *persistentStorePath = GetDocumentPathFileName(coreDataPersistentStorePath);
