...
typedef NS_ENUM(NSInteger,ZZCircleProgressTextStyle ){
    ZZCircleProgressTextStyle_normal = 0,
    ZZCircleProgressTextStyle_custom  ,
};
...
@property (nonatomic, assign) IBInspectable NSInteger textStyle;
@property (nonatomic, copy) IBInspectable NSString *  progressText;
@property (nonatomic, copy)  NSAttributedString *  progressTextAtr;
//初始化
- (instancetype)initWithFrame:(CGRect)frame
                ...
                pathFillColor:(UIColor *)pathFillColor
                 ...
                 textStyle:(ZZCircleProgressTextStyle)style;
