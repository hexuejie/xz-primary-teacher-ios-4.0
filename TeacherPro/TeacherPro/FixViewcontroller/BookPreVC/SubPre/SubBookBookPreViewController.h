//
//  SubBookBookPreViewController.h
//  TeacherPro
//
...
@interface SubBookBookPreViewController : BaseCollectionViewController<ReleaseAddBookworkCellDelegate> ////////绘本  BookTypeCartoon
////////书本作业 预览 子页面

@property (nonatomic, assign) BOOL isPhonics;
