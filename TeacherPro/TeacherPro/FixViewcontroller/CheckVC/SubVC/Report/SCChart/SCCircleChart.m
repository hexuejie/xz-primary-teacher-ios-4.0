  ...
  overrideLineWidth:(NSNumber *)overrideLineWidth
{
    ...
    if (self) {
        ...
        _circleBackground.strokeColor = (hasBackgroundShadow ? backgroundShadowColor.CGColor : HexRGB(0xF2F2F2).CGColor);
        ...
        [_countingLabel setFont:[UIFont systemFontOfSize:10.0f]];
        [_countingLabel setTextColor:HexRGB(0x8A8F99)];
