...
#import "StudentRowTwoTypeCell.h"
#import "ProUtils.h"
#import "PublicDocuments.h"
#import "Masonry.h"

@interface StudentRowTwoTypeCell()
...
@end
@implementation StudentRowTwoTypeCell
...
- (IBAction)leftAction:(id)sender {
    if (self.touchBlock) {
        self.touchBlock(StudentRowTwoTypeCellTouchType_sendMessage, self.index);
    }
...
- (IBAction)centerAction:(id)sender {
    if (self.touchBlock) {
        self.touchBlock(StudentRowTwoTypeCellTouchType_Info, self.index);
    }
}

- (IBAction)rightAction:(id)sender {
    if (self.touchBlock) {
        self.touchBlock(StudentRowTwoTypeCellTouchType_KickedClass , self.index);
    }
}
