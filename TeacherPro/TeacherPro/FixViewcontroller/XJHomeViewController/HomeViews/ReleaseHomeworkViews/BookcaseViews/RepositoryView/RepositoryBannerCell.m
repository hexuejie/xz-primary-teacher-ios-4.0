...
@interface RepositoryBannerCell()<SDCycleScrollViewDelegate>
...
@implementation RepositoryBannerCell
...
- (IBAction)bookAction:(id)sender {
    if (self.bottomBlock) {
          self.bottomBlock(RepositoryBannerBottomType_book);
    }
}

- (IBAction)cartoonAction:(id)sender {
    if (self.bottomBlock) {
        self.bottomBlock(RepositoryBannerBottomType_cartoon);
    }
}
- (IBAction)assistantsAction:(id)sender {
    
    if(self.bottomBlock){
        self.bottomBlock(RepositoryBannerBottomType_assistants);
    }
}
