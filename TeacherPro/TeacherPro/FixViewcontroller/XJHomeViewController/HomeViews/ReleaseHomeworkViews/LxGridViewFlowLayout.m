...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            DecorateImageViewCell *sourceCell = (DecorateImageViewCell *)sourceCollectionViewCell;
...
- (void)panGestureRecognizerTriggerd:(UIPanGestureRecognizer *)pan
{
    switch (pan.state) {
        ...
        case UIGestureRecognizerStateChanged:
        {
            ...
            if (sourceIndexPath == nil|| (destinationIndexPath == nil) || [destinationIndexPath isEqual:sourceIndexPath]) {
                return;
            }
