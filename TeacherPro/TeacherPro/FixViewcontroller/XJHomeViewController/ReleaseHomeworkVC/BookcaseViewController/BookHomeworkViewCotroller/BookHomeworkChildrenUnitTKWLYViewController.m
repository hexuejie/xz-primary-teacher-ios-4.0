//
//  BookHomeworkChildrenUnitTKWLYViewController.m
//  TeacherPro
//
...
#import "YYCache.h"
NSString * const BookHomeworkAdjustmentRepeatedNumberCellTKWLYIdentifier =@"BookHomeworkAdjustmentRepeatedNumberCellTKWLYIdentifier";
NSString * const BookHomeworkUnitRemindingHeaderViewTKWLYIdentifier =@"BookHomeworkUnitRemindingHeaderViewTKWLYIdentifier";

NSString * const BookHomeworkChildrenUnitSectionHeaderViewTKWLYIdentifier =@"BookHomeworkChildrenUnitChooseCellTKWLYIdentifier";
NSString * const BookHomeworkChildrenUnitChooseCellTKWLYIdentifier =@"BookHomeworkChildrenUnitChooseCellTKWLYIdentifier";

@interface BookHomeworkChildrenUnitTKWLYViewController ()

@end

@implementation BookHomeworkChildrenUnitTKWLYViewController
...
- (void)registerCell{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([BookHomeworkUnitRemindingHeaderView class]) bundle:nil] forHeaderFooterViewReuseIdentifier: BookHomeworkUnitRemindingHeaderViewTKWLYIdentifier];
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([BookHomeworkChildrenUnitSectionHeaderView  class]) bundle:nil] forHeaderFooterViewReuseIdentifier: BookHomeworkChildrenUnitSectionHeaderViewTKWLYIdentifier];
    
    
     [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([BookHomeworkAdjustmentRepeatedNumberCell class]) bundle:nil] forCellReuseIdentifier:BookHomeworkAdjustmentRepeatedNumberCellTKWLYIdentifier];
    
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([BookHomeworkChildrenUnitChooseCell  class]) bundle:nil] forCellReuseIdentifier:BookHomeworkChildrenUnitChooseCellTKWLYIdentifier];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if (section == 0) {
        BookHomeworkUnitRemindingHeaderView * tempHeaderView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:BookHomeworkUnitRemindingHeaderViewTKWLYIdentifier];
        NSString * remindingType = @"课本点读";
        ...
        BookHomeworkChildrenUnitSectionHeaderView * tempHeaderView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:BookHomeworkChildrenUnitSectionHeaderViewTKWLYIdentifier];
        NSInteger index = section -2;
        BookUnitModel *model  = self.model.bookUnits[index];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 1) {
        BookHomeworkAdjustmentRepeatedNumberCell * tempCell = [tableView dequeueReusableCellWithIdentifier:BookHomeworkAdjustmentRepeatedNumberCellTKWLYIdentifier];
        WEAKSELF
        ...
        BookHomeworkChildrenUnitChooseCell * tempCell = [tableView dequeueReusableCellWithIdentifier:BookHomeworkChildrenUnitChooseCellTKWLYIdentifier];
        ...
        if((!childrenModel.hasRead||![childrenModel.hasRead boolValue])){
            //没有内容不能选题
